...
%DIF DEL ManuscriptR1.tex   Fri Mar 27 01:33:07 2026
%DIF ADD ManuscriptR2.tex   Fri Mar 27 01:33:07 2026
%
...
%DIF 21-26c21-22
%DIF < %
%DIF < %\documentclass{svjour3}                     % onecolumn (standard format)
%DIF < %\documentclass[smallcondensed]{svjour3}     % onecolumn (ditto)
%DIF < \documentclass[smallextended]{svjour3}       % onecolumn (second format)
%DIF < %\documentclass[twocolumn]{svjour3}          % twocolumn
%DIF < %
%DIF -------
 %DIF > 
\documentclass[smallextended]{svjour3}        %DIF > 
%DIF -------
...
\usepackage{etoolbox} %DIF > 
 %DIF > 
\makeatletter %DIF > 
\patchcmd{\@maketitle} %DIF > 
  {\authorfont} %DIF > 
  {\authorfont\fontsize{10}{12}\selectfont} %DIF > 
  {}{\errmessage{Failed to patch author font size}} %DIF > 
\makeatother %DIF > 
 %DIF > 
 %DIF > 
\makeatletter %DIF > 
\patchcmd{\@maketitle} %DIF > 
  {\divide\rubricwidth by144\multiply\rubricwidth by89} %DIF > 
  {\divide\rubricwidth by124\multiply\rubricwidth by120} %DIF > 
  %{\divide\rubricwidth by144\multiply\rubricwidth by89} %DIF > 
  %{\divide\rubricwidth by144\multiply\rubricwidth by120} %DIF > 
  {}{} %DIF > 
\makeatother %DIF > 
 %DIF > 
 %DIF > 
\makeatletter %DIF > 
\let\orig@mkpream\@mkpream %DIF > 
\def\@mkpream#1{% %DIF > 
  % Wrap every column spec with @{} ... @{} globally %DIF > 
  \orig@mkpream{@{}#1@{}}% %DIF > 
} %DIF > 
\makeatother %DIF > 
 %DIF > 
 %DIF > 
\renewcommand{\abstractname}{Abstract\par} %DIF > 
 %DIF > 
%DIF -------
...
%DIF 114a141-166
\titleclass{\subparagraph}{straight} %DIF > 
 %DIF > 
% Formatting (no numbering) %DIF > 
\titleformat{\subparagraph}[runin] %DIF > 
  {\fontsize{8}{10}\selectfont\bfseries\sffamily}  % font %DIF > 
  {}                                 % empty label = no number %DIF > 
  {0pt}                               % spacing between label and title %DIF > 
  {}                                 % code before the title %DIF > 
 %DIF > 
% Spacing (adjust as desired) %DIF > 
\titlespacing{\subsubparagraph} %DIF > 
  {0pt}{3.25ex plus 1ex minus .2ex}{1.5ex plus .2ex} %DIF > 
 %DIF > 
% Make \paragraph a run-in heading %DIF > 
\titleformat{\paragraph}[runin] %DIF > 
  {\fontsize{9}{11}\selectfont\sffamily\bfseries} % format %DIF > 
  {}                                % label (none) %DIF > 
  {0pt}                             % spacing between label and title text %DIF > 
  {}                                % code before the title %DIF > 
  []                                % code after the title %DIF > 
 %DIF > 
\titlespacing*{\paragraph} %DIF > 
  {0pt}                             % left indent %DIF > 
  {1.5ex plus 1ex minus .2ex}       % space before the heading %DIF > 
  {1em}                             % space between heading and following text %DIF > 
   %DIF > 
%DIF -------
\titleformat{\section}
...
%DIF 121c174
%DIF <   {\sffamily\bfseries\itshape\fontsize{9}{11}\selectfont}{\thesubsubsection}{0.5em}{}
%DIF -------
  {\sffamily\bfseries\fontsize{9}{11}\selectfont}{\thesubsubsection}{0.5em}{} %DIF > 
%DIF -------

%DIF 123a176-182
\usepackage{fancyhdr} %DIF > 
\pagestyle{fancy} %DIF > 
\fancyhf{}                  % clear all header/footer fields %DIF > 
\fancyhead[LO]{\sffamily\footnotesize Empirical Software Engineering} %(2026)} % 31:40}   %DIF > 
\fancyhead[LE]{\sffamily\footnotesize 40 Page \thepage{} of 56}   %DIF > 
\fancyhead[RO]{\sffamily\footnotesize Page \thepage{} of 56} %DIF > 
\fancyhead[RE]{\sffamily\footnotesize Empirical Software Engineering }%(2026) 31:40} %DIF > 
%DIF -------
...
\normalsize 
%DIF 138-139c199-202
%DIF < \vspace{0.5em}\hangindent=1em \textmd{\textsc{Proposition #1}: #2}\vspace{0.5em}
%DIF < \end{quote}
%DIF -------
\vspace{0.5em}%\hangindent=1em  %DIF > 
\noindent \textbf{\sffamily\fontsize{9}{11}\selectfont Proposition #1}: \textit{#2} %DIF > 
\vspace{0.5em} %DIF > 
%\end{quote} %DIF > 
%DIF -------
}
...
\usepackage{tikz} %DIF > 
\usetikzlibrary{svg.path} %DIF > 
\definecolor{orcidlogocol}{HTML}{A6CE39} %DIF > 
\tikzset{ %DIF > 
  orcidlogo/.pic={ %DIF > 
    \fill[orcidlogocol] svg{M256,128c0,70.7-57.3,128-128,128C57.3,256,0,198.7,0,128C0,57.3,57.3,0,128,0C198.7,0,256,57.3,256,128z}; %DIF > 
    \fill[white] svg{M86.3,186.2H70.9V79.1h15.4v48.4V186.2z} %DIF > 
                 svg{M108.9,79.1h41.6c39.6,0,57,28.3,57,53.6c0,27.5-21.5,53.6-56.8,53.6h-41.8V79.1z M124.3,172.4h24.5c34.9,0,42.9-26.5,42.9-39.7c0-21.5-13.7-39.7-43.7-39.7h-23.7V172.4z} %DIF > 
                 svg{M88.7,56.8c0,5.5-4.5,10.1-10.1,10.1c-5.6,0-10.1-4.6-10.1-10.1c0-5.6,4.5-10.1,10.1-10.1C84.2,46.7,88.7,51.3,88.7,56.8z}; %DIF > 
  } %DIF > 
} %DIF > 
 %DIF > 
\DeclareRobustCommand{\orcidicon}[1]{\href{https://orcid.org/#1}{\mbox{\scalerel*{ %DIF > 
\begin{tikzpicture}[yscale=-1,transform shape] %DIF > 
\pic{orcidlogo}; %DIF > 
\end{tikzpicture} %DIF > 
}{|}}}} %DIF > 
 %DIF > 
\usepackage{etoolbox} %DIF > 
 ...
 %DIF > 
% \makeatletter %DIF > 
% \let\old@svabstract\abstract %DIF > 
% \renewenvironment{abstract}{% %DIF > 
%   \old@svabstract %DIF > 
%   \vspace*{-1.2ex}% adjust this value %DIF > 
%   \leavevmode\par %DIF > 
% }{\endabstract} %DIF > 
% \makeatother %DIF > 
%DIF -------
...
\title{Maintaining \DIFdelbegin \DIFdel{Shared Understanding }\DIFdelend \DIFaddbegin \DIFadd{shared understanding }\DIFaddend of \DIFdelbegin \DIFdel{Non-Functional Requirements }\DIFdelend \DIFaddbegin \DIFadd{non-functional requirements }\DIFaddend in \DIFdelbegin \DIFdel{Small Companies }\DIFdelend \DIFaddbegin \DIFadd{small companies }\DIFaddend using \DIFdelbegin \DIFdel{Continuous Software Engineering}\DIFdelend \DIFaddbegin \DIFadd{continuous software engineering}\DIFaddend }


\titlerunning{Maintaining Shared Understanding of Non-Functional Requirements}

\author{Colin Werner \DIFaddbegin \orcidicon{0000-0002-4541-7796} \DIFaddend \and
        Laura Okpara \DIFaddbegin \orcidicon{0000-0002-1038-5050} \DIFaddend \and 
        Klaas-Jan Stol \DIFaddbegin \orcidicon{0000-0002-1038-5050} \DIFaddend \and
        Daniela Damian \DIFaddbegin \orcidicon{0000-0002-1038-5050}
\DIFaddend }
...
\date{\DIFaddbegin \sffamily\footnotesize  \DIFaddend Received: \DIFdelbegin \DIFdel{13 }\DIFdelend \DIFaddbegin \DIFadd{18 }\DIFaddend March \DIFdelbegin \DIFdel{2025. Revised}\DIFdelend \DIFaddbegin \DIFadd{2025 / Accepted}\DIFaddend : \DIFdelbegin \DIFdel{23 July 2025. }\DIFdelend \DIFaddbegin \DIFadd{3 November 2025}\DIFaddend } %DIF < Accepted: date}
%DIF <  The correct dates will be entered by the editor
%DIF > \\
%DIF >  \copyright{} The Author(s), under exclusive licence to Springer Science+Business Media, LLC, part of Springer Nature 2025}
...
\DIFaddbegin \keywords{Non-functional requirements · Shared understanding · Small software
...
\DIFaddbegin \DIFadd{Together, these propositions represent a dialectic process theory, which we labelled the Iceberg theory, describing how a lack of shared understanding is detected through what we previously have labelled `triggers' \mbox{%DIFAUXCMD
\citep{werner2020re} }\hskip0pt%DIFAUXCMD
(Proposition 1), and how these critical events can lead organizations to respond to this lack of shared understanding by what we call management practices (Proposition 2). Besides building shared understanding of NFRs }\textit{\DIFadd{in response to}} \DIFadd{events, we also found that companies use communication practices to }\textit{\DIFadd{proactively}} \DIFadd{build shared understanding of NFRs (Proposition 3), and that different NFRs require different practices (Proposition 4). Further, we found that the specific characteristics and context associated with continuous software engineering in small companies can introduce a variety of challenges (Proposition 5). Finally, we observe that the boundary around the state of shared understanding of an NFR is in constant flux (Proposition 6).
}

\DIFaddend In the remainder of this article, we describe the background of the phenomenon we focus on in Section \ref{background}, which concludes with a summary of our current understanding and open questions. We then present details on our theory development process in Section~\ref{methodology}.
...
\DIFdelbegin \DIFdel{Together, these propositions represent a dialectic process theory, which we labelled the Iceberg theory, describing how a lack of shared understanding is detected through what we previously have labelled `triggers' \mbox{%DIFAUXCMD
\citep{werner2020re} }\hskip0pt%DIFAUXCMD
and how these critical events can lead organizations to respond to this lack of shared understanding and the challenges that arise during that process.
}\DIFdelend Section~\ref{sec:discussion} discusses the validity and evaluation of the Iceberg theory before setting out a number of implications for research and practices. We conclude this article in Section~\ref{sec:conclusion}.
...
\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{P{2cm}p{9.2cm}}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{P{2cm}p{9.6cm}}
\DIFaddendFL 
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{table}[!bt]
\DIFaddendFL \caption{Identifying relationships among concepts: antecedents and consequences}
...
\DIFdelbegin \DIFdel{Table~\ref{tab:theorizing} summarizes the overall theorizing process using \mbox{%DIFAUXCMD
\citet{eisenhardt1989building}}\hskip0pt%DIFAUXCMD
' s process as a guiding structure.     }\DIFdelend \DIFaddbegin \DIFadd{To illustrate the refinement process: Table~\ref{tab:proprefinement} shows an early version of Proposition 2, and of Proposition 3, which originated in insights gained from the fourth case study.
...
\caption{\DIFaddFL{Example of refining propositions}}
    \label{tab:proprefinement}
    \centering
    \begin{tabular}{p{2cm}p{4cm}p{5.3cm}}
\toprule
\DIFaddFL{Proposition }& \DIFaddFL{Earlier version }& \DIFaddFL{Final version }\\
\midrule 
\DIFaddFL{Proposition 2 }& \DIFaddFL{A trigger prompts an organization to implement a practice to build shared understanding of a non-functional requirement.     }&   \DIFaddFL{Management practices are primarily used to reactively build a shared understanding of non-functional requirements, in response to triggers.}\\
\addlinespace
\DIFaddFL{Proposition 3 }& \DIFaddFL{An organization may also implement a practice unprompted.  }& \DIFaddFL{Communication practices are primarily used to proactively build a shared understanding of non-functional requirements. }\\
\bottomrule 
\end{tabular}    
\end{table}
...
\DIFaddend \subsection{Positionality of the Investigators}
...
We present a visual presentation of the theory in Figure~\ref{fig:iceberg}\DIFdelbegin \DIFdel{in Section~\ref{sec:discussion}}\DIFdelend .
...
\DIFaddbegin \begin{figure}[!h]
    ...
    \caption{\DIFaddFL{The Iceberg theory of managing shared understanding of non-functional requirements in continuous software engineering contexts}}
    \label{fig:iceberg}

\end{figure}

\DIFaddend \subsection{Detecting Lack of Shared Understanding of Non-Functional Requirements}
...
\footnotesize 
%\small 
\DIFdelbegin %DIFDELCMD < \begin{longtable}{P{1.5cm}p{4.8cm}p{3cm}p{1.3cm}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}{P{1.5cm}p{4.8cm}p{3.3cm}p{1.3cm}}
\DIFaddend \caption{Categories of triggering events and selected examples}\label{tab:triggers}\\
    \toprule
...
\DIFaddbegin \paragraph{\DIFadd{New requirements}} \DIFaddend The first category of triggers is the emergence of new requirements: during design and implementation discussions, developers may realize that parts of the design were not sufficiently specified. For example, at Alpha, some functionality had to be extended, and developers were unclear as to how to achieve this without considerable rework. The discussion among developers led to the realization that they lacked a shared understanding.
...
\DIFdelbegin \DIFdel{For example, }\DIFdelend \DIFaddbegin 

\paragraph{\DIFadd{Quantifying an NFR}} \DIFadd{A first management practice is }\DIFaddend quantifying an NFR\DIFaddbegin \DIFadd{, which }\DIFaddend is a management practice because the ability to do so allows an organization to assess, validate, and monitor \DIFdelbegin \DIFdel{an }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend NFR over time. This, in turn, creates a feedback loop in the form of information about how the system performs in terms of NFRs, which feeds back into the development cycle. Quantifying NFRs as a practice is consistent with \citet{wagner2019status}'s finding that approximately half of the respondents to their large-scale survey used ``quantified textual documentation for non-functional requirements.''
...
\DIFaddbegin \paragraph{\DIFadd{Offloading an NFR}} \DIFaddend A second management practice is offloading an NFR, which we found to be the most common approach among the small companies that we studied. 
...
\DIFaddbegin \textbf{\DIFadd{Custom tools and standards.}} \DIFaddend A third management practice is developing custom tools and standards. 
...
\DIFaddbegin \paragraph{\DIFadd{Capturing NFRs in version control}} \DIFaddend The fourth and final management practice that we identified is codifying and capturing an NFR in version control. 
...
\DIFaddbegin \paragraph{\DIFadd{Leveraging Past Experience}} \DIFaddend The second communication practice to build a shared understanding of NFRs is to leverage past experience. 
...
\DIFaddbegin \paragraph{\DIFadd{Wireframing}} \DIFaddend The third communication practice we identified is wireframing, which includes the use of visualization tools to create designs, mock-ups, demos, or sketches to describe NFRs and improve developers' understanding of NFRs.
...
\DIFaddbegin \paragraph{\DIFadd{Knowledge-sharing activities}} \DIFaddend The fourth communication practice to support the building of a shared understanding of NFRs is the use of knowledge-sharing activities. These include `guild' meetings or other regularly scheduled meetings.
...
\DIFaddbegin \paragraph{\DIFadd{Asking questions}} \DIFaddend The last communication practice we identified was asking questions. 
...
\DIFaddbegin \textbf{\DIFadd{Fast pace leads to deprioritization of NFRs.}} \DIFaddend The first challenge is that NFRs tend to get deprioritized due to an emphasis on fast iterations. As CSE seeks to deliver new functionality quickly, minimizing the time between request and delivery \citep{fitzgerald2017continuous}, there is a tendency to prioritize functional requirements, as succinctly shared by one developer at Beta: \textmd{``we tend to deprioritize ones that aren't like hard functional problems.''}
...
\DIFaddbegin \paragraph{\DIFadd{NFRs are hard to automate}} \DIFaddend Related to this is the challenge that some NFRs are very hard to automate.  CSE emphasizes a fully automated build, test, and delivery pipeline \citep{fitzgerald2017continuous,fowler-continuous-int,klotins2023continuous}.  
...
\DIFaddbegin \paragraph{\DIFadd{Inadequate communication}} \DIFaddend A fourth challenge we identified in the context of CSE in small organizations is insufficient communication among developers and stakeholders. The cross-cutting nature of NFRs means that developers working on different parts of a system need to communicate regularly. 
...
\DIFaddbegin \paragraph{\DIFadd{Knowledge of NFRs is not documented}} \DIFaddend A fifth challenge is that knowledge of NFRs remains undocumented. Tacit knowledge of NFRs means that it is difficult for newly joined staff to develop a shared understanding with their colleagues, as one developer at Beta described:
...
\DIFaddbegin \paragraph{\DIFadd{Loss of control}} \DIFaddend The last challenge we identified is the loss of control over an NFR as a result of offloading it to a third-party cloud provider.
...
%DIFDELCMD <     \centering
%DIFDELCMD <      \includegraphics[clip,trim={0 0 0 0},width=12cm]{icebergtheory-11sep24.pdf}
%DIFDELCMD < 
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{The Iceberg theory of managing shared understanding of non-functional requirements in continuous software engineering contexts}}
    %DIFAUXCMD
%DIFDELCMD < \label{fig:iceberg}
%DIFDELCMD <     
...
%DIFDELCMD < %%%
\DIFdelend \section{Toward a Theory of Maintaining Shared Understanding of\\ Non-Functional Requirements}
...
Having argued that the Iceberg theory is, indeed, a scientific theory, we now ask\DIFdelbegin \DIFdel{the question}\DIFdelend : how much confidence can we have in the Iceberg theory? %DIF < 
\DIFaddbegin \DIFadd{And, how could we evaluate or test the Iceberg theory? In this section we address these two questions.
}

\DIFaddend The theory is developed based on analysis of qualitative research\DIFdelbegin \DIFdel{. 
The }\DIFdelend \DIFaddbegin \DIFadd{; one }\DIFaddend advantage of using qualitative research is that it offers a more holistic view to obtain much richer and deeper data than what could have been achieved using, for example, survey research \citep{marshall2014designing}. However, findings from field studies are inherently limited in their generalizability \citep{stol2018abc}. Through substantive and inductive theory development, we sought to mitigate this limitation; we generated propositions that are grounded in empirical data, leveraging empirical observations to theoretical generalizability as opposed to statistical generalizability. 


\DIFdelbegin \DIFdel{We }\DIFdelend \DIFaddbegin \DIFadd{To determine how much confidence we can have in the Iceberg theory, we }\DIFaddend adopt Lincoln and Guba's quality evaluation criteria to evaluate the proposed theory, including their recommended techniques to overcome the specified limitations.
In particular, credibility, dependability, confirmability, and transferability are discussed in sequence \citep{lincoln1985naturalistic, guba1994competing}\DIFaddbegin \DIFadd{, followed by a brief discussion of how one might test the Iceberg theory}\DIFaddend .
...
\DIFaddbegin \subsubsection{\DIFadd{Evaluating the Robustness of the Iceberg Theory}}
\DIFadd{We now address the question: how could we evaluate or test the Iceberg theory? When discussing theory testing, \mbox{%DIFAUXCMD
\citet{popper1980} }\hskip0pt%DIFAUXCMD
is frequently cited for his idea of falsification; that is, Popper held the view that theorizing involves the development of statements in a form that allows the researcher to test them against observations in the real world \mbox{%DIFAUXCMD
\citep[p. 614]{gregor2006nature}}\hskip0pt%DIFAUXCMD
. Arguably, the propositions of the Iceberg theory are falsifiable, but we argue that this is not an effective way forward for several reasons. First, Popper in effect sets constraints on what `theory' is by demanding that all statements of a theory must be falsifiable. This view is far more narrow than \mbox{%DIFAUXCMD
\citet{sandberg2021meanings}}\hskip0pt%DIFAUXCMD
's broader view that we adopt in this article, and also \mbox{%DIFAUXCMD
\citet{gregor2006nature}}\hskip0pt%DIFAUXCMD
's view, as she presented different types of theory. Falsification as a form of testing is primarily suitable for theories for explaining and predicting (\mbox{%DIFAUXCMD
\citet{gregor2006nature}}\hskip0pt%DIFAUXCMD
's Type 4 theory). Indeed, the Iceberg theory's purpose lies closer to that of \mbox{%DIFAUXCMD
\citet{gregor2006nature}}\hskip0pt%DIFAUXCMD
's Type 1, namely analysis and description.
...
Third, the Iceberg theory is more closely aligned to \mbox{%DIFAUXCMD
\citet{sandberg2021meanings}}\hskip0pt%DIFAUXCMD
's pluralistic and inclusive view of what constitutes theory, rejecting that there is a single universal standard such as Popper's view. Which criteria, then, should one use to judge a theory? This will depend on which philosopher of science we ask. Rather than asking how accurately the theory describes objective reality, pragmatists (such as Peirce, Dewey, and James) would subscribe to an instrumentalist view, namely that theories should be evaluated in terms of how useful they are. This means to focus on questions such as: Does the theory work in practice? Does it fit with experience? And, is the theory open to revision? 
}


%DIF > What criteria we should use to judge theories vary depending on which philosopher we ask. Pragmatists like Pierce argue it's impossible to figure out if a theory is valid (i.e. true) so we should focus on practical usefulness.

\DIFaddend \subsection{Implications for Research}
\label{academic}

A good theory  is ``useful'' \citep{mintzberg2017developing}, and helps direct future research efforts ``to protect researchers from wasting time'' \cite[p. 8]{miner1980}; the Iceberg theory suggests a number of open-ended questions and unexplored avenues that merit future attention \DIFaddbegin \DIFadd{(see Table~\ref{tab:implications})}\DIFaddend .
...
\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{p{4cm}p{7cm}} %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{p{4cm}p{7.7cm}} \DIFaddendFL %p{4cm}}
...
Further, going beyond shared understanding of NFRs, one might explore whether this cyclical process of creation and decay applies to other areas within software engineering practice. Closely related are, of course, knowledge management \citep{bjornson2008knowledge} and architectural knowledge \citep{capilla2016}. As Generative AI is quickly emerging as a pivotal technology that is changing the nature of software engineering \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{stray2025genai}}\hskip0pt%DIFAUXCMD
}\DIFaddend , it will become important to understand the interaction between human developers and AI agents, and how this might change the nature of ``knowledge'' that we have of systems that are co-created with AI. 
...
In sum, the Iceberg theory constitutes a parsimonious explanation of a practical phenomenon in software engineering practice. We envisage the theory as ``a node'' as a kernel that can attract further knowledge \cite[p. xi]{miner2015organizational}.\DIFaddbegin \\
\DIFaddend 
...
%DIFDELCMD < %%%
\section*{\DIFdel{Declarations}}
%DIFAUXCMD
%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Funding}}
%DIFAUXCMD
\DIFdel{This work is supported by Research Ireland (formerly Science Foundation Ireland) grant 13/RC/2094-P2 to Lero.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Ethical Approval}}
%DIFAUXCMD
\DIFdel{Ethical approval for the field work underpinning the theory development study presented in this paper was received from the University of Victoria, Canada.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Author Contributions}}
%DIFAUXCMD
\DIFdel{Colin Werner: study conceptualization, data collection, data analysis, initial draft, revisions. Laura Okpara: study conceptualization, data collection, data analysis. Klaas-Jan Stol: study conceptualization, data analysis, initial draft, revisions, Daniela Damian: study conceptualization, initial draft, revisions. 
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Data Availability}}
%DIFAUXCMD
\DIFdel{All data were collected at the four organizations; we cannot make these data publicly available as the data were collected under non-disclosure agreements. 
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Conflict of Interest}}
%DIFAUXCMD
\DIFdel{The authors declare no conflict of interest.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Clinical trial number}}
%DIFAUXCMD
\DIFdel{Clinical trial number not applicable. 
}%DIFDELCMD < 

%DIFDELCMD < %%%
\subsubsection*{\DIFdel{Statement on the use of Generative AI}}
%DIFAUXCMD
\DIFdel{The authors wish to declare that no generative AI tools were used for any step in the research process, including the writing of this article. Any resemblance of AI-generated text or style is because AI technology has learned from the best, not vice versa.
}%DIFDELCMD < 
...
\DIFaddend \section{Summary of Data Collection}
...
\DIFdelbegin \paragraph{\DIFdel{Delta}}
%DIFAUXCMD
\addtocounter{paragraph}{-1}%DIFAUXCMD
\DIFdel{Company Delta develops loyalty, rewards, and referral products for other organizations. The products are heavily client-focused, anchored in components that are visually-rich, including integrating various 3rd party platforms and maintaining a rich dataset of client information. Key NFRs for Delta are usability, maintainability, and performance. 
}%DIFDELCMD < 
...
\footnotesize
    ...
    P{1.8cm}}
    \toprule 
    \DIFdelbeginFL %DIFDELCMD < \multicolumn{5}{c}{%%%
\DIFdelendFL \DIFaddbeginFL \multicolumn{5}{l}{\DIFaddendFL Organization demographics} & \DIFdelbeginFL %DIFDELCMD < \multicolumn{5}{c}{%%%
\DIFdelendFL \DIFaddbeginFL \multicolumn{5}{l}{\DIFaddendFL Data collection}\\
...
\DIFaddbegin \paragraph{\DIFadd{Delta}}
\DIFadd{Company Delta develops loyalty, rewards, and referral products for other organizations. The products are heavily client-focused, anchored in components that are visually-rich, including integrating various 3rd party platforms and maintaining a rich dataset of client information. Key NFRs for Delta are usability, maintainability, and performance. 
}

\DIFaddend \subsection{Data Collection}
...
Two of the authors spent multiple days over a few months embedded in situ at each of the four organizations \DIFaddbegin \DIFadd{(see Table~\ref{tab:informants})}\DIFaddend .  
...
\caption{Informants' teams interviewed at the case organizations}
    \label{tab:teams}
    \centering
    \DIFdelbeginFL %DIFDELCMD < \begin{tabular}{p{2cm}P{9cm}}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{p{2cm}P{9.7cm}}
    \DIFaddendFL \toprule 
    Organization & Teams  \\
    \midrule 
...
These open-ended interviews were conducted by two investigators and lasted between 30--90 minutes remotely or at the organization's office. \DIFaddbegin \DIFadd{All interviews were based on a set of base questions:
}\DIFaddend 

\DIFaddbegin \begin{enumerate}
\item \DIFadd{Are you familiar with the term DevOps? Are you familiar with the term continuous (integration, delivery, deployment)?
}\item \DIFadd{If you are familiar, how do you define these terms?
}\item  \DIFadd{Does your organization practice any continuous practices or DevOps? If so, what are they?
}\item \DIFadd{Do you define NFRs? 
%DIF > If the interviewee answers no, we can first provide an example of an FR to help an interview conceptualize. If the interviewee is still confused, we can provide an example of a quality attribute of a system (i.e. performance requirements) or activities that the organization conducts to ensure a specific quality. Those activities may be using infrastructure as code to improve maintainability.
}\item \DIFadd{How do you define an NFR?
}\item \DIFadd{Which NFRs are important to your organization?
}\item \DIFadd{How do you manage NFRs?
}\item \DIFadd{How do you document an NFR?
}\item \DIFadd{In particular, are any NFRs in your source control?
}\item \DIFadd{How do you test or ensure an NFR is satisfied?
}\item \DIFadd{How do you trace an NFR through the continuous development?
}\item \DIFadd{What happens when an NFR fails? Is there a feedback loop from continuous development?
}\item \DIFadd{Does an NFR require additional resources (additional approval, testing, etc?) when developing it?
}\item \DIFadd{How do you ensure everyone is aware of a particular NFR?
}\end{enumerate}

\DIFaddend Depending on an interviewee's role or primary work, we asked additional probing questions on more specific subjects. 
...
\footnotesize 
\subparagraph{\DIFadd{Acknowledgments}}
\DIFadd{We are grateful to the three anonymous reviewers and editor for their constructive feedback, which has led to a better article. 
}

\subparagraph{\DIFadd{Author Contributions}}
\DIFadd{Colin Werner: study conceptualization, data collection, data analysis, initial draft, revisions. Laura Okpara: study conceptualization, data collection, data analysis. Klaas-Jan Stol: study conceptualization, data analysis, initial draft, revisions, Daniela Damian: study conceptualization, initial draft, revisions. 
}

\subparagraph{\DIFadd{Funding}}
\DIFadd{This work is supported by Research Ireland (formerly Science Foundation Ireland) grant 13/RC/2094-P2 to Lero.
}

\subparagraph{\DIFadd{Data Availability}}
\DIFadd{All data were collected at the four organizations; we cannot make these data publicly available as the data were collected under non-disclosure agreements. 
}


\section*{\DIFadd{Declarations}}

\subparagraph{\DIFadd{Ethical Approval}}
\DIFadd{Ethical approval for the field work underpinning the theory development study presented in this paper was received from the University of Victoria, Canada.
}



\subparagraph{\DIFadd{Conflict of Interest}}
\DIFadd{The authors declare no conflict of interest.
}

\subparagraph{\DIFadd{Clinical trial number}}
\DIFadd{Clinical trial number not applicable. 
}

\subparagraph{\DIFadd{Statement on the use of Generative AI}}
\DIFadd{The authors wish to declare that no generative AI tools were used for any step in the research process, including the writing of this article. Any resemblance of AI-generated text or style is because AI technology has learned from the best, not vice versa.
}\DIFaddend 
