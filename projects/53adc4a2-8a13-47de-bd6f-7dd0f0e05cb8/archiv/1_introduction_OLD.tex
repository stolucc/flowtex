...
Appropriate changes to the school structures will seek to support the implementation of the action plan. These systemic changes will endeavour to bring about a positive EDI culture (see Actions~\ref{action:intro:edi}. %% KS Ethos action item gone? and \ref{action:intro:ethos}).
...
Table~\ref{tab:sat} presents details of all SAT members.
...
\input{tables1/tab_initial_expanded_sat}

%%\input{tables1/tab_sat_team_col}

\input{tables1/tab_sat_team_new}
...
\input{tables1/tab_response_bygender}

\input{tables1/tab_response_byrole}
...
% \begin{action}[label=action:record:hiring:pms]{Record Gender Information for Hiring Process of PMS Staff}
% \actrecordhiringpms
% \hfill{
...
\begin{actionblock}{\ksspace{}Record Hiring PMS}{record:hiring:pms}
  \actrecordhiringpms 
  \hfill{
    \hypersetup{hidelinks}
...
\begin{actionblock}{\ksspace{}Record Hiring PhD}{record:hiring:phd}
  \actrecordhiringphd 
  \hfill{
    \hypersetup{hidelinks}
    \hyperlink{aa0}{\gotoactionsymbol{}
...
Cross-cutting actions and actions that are outside of the remit of the standing committees will be managed by the EDIIC Chair in consultation with the \ac{HOS}. In particular, the gender balance of staff and students will be monitored annually (Action~\ref{action:gender:population:survey}), and a staff survey will be conducted at the end of Year 3 and Year 4 to guage satisfaction with the implementation of the  AS Action plan (Action~\ref{action:staff:survey}). Both of these actions will inform school policy.

\newcommand{\actgenbalpopsurvey}{Monitoring the Gender Balance of Student and Staff populations annually.
}
\begin{actionblock}{\ksspace{}Monitor Gender Balance}{gender:population:survey}
\actgenbalpopsurvey
\hfill{
    \hypersetup{hidelinks}
    \hyperlink{a3}{\gotoactionsymbol{}}
...
\begin{actionblock}{\ksspace{}Follow-up Staff Surveys}{staff:survey}
\actstaffsurvey
\hfill{
    \hypersetup{hidelinks}
    \hyperlink{a3}{\gotoactionsymbol{}}
